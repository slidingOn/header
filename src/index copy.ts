 ...
 * Build styles
 */
import type { API, BlockTool, PasteEvent, ToolConstructable } from '@editorjs/editorjs';
import './index.css';
...
export default class Header implements BlockTool{
  ...
  constructor({ data, config, api, readOnly }: { data: any, config: Ref, api: API, readOnly: boolean }) {
    console.log(config)
    this.api = api;
